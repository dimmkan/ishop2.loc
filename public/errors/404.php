...
<head>
    ...
    <!-- //Meta tag Keywords -->
    <link rel="stylesheet" href="errors/404/css/style.css" type="text/css" media="all" /><!-- Style-CSS -->
    <link href="errors/404/css/font-awesome.css" rel="stylesheet"><!-- font-awesome-icons -->
</head>
    ...
    <div class="covers-main w3layouts">
        <div class="wrapper">
            <div class="main-cover w3">
                <h1>
                    <a href="<?=PATH?>" class="logo">Wed Error Page</a>
                </h1>
                ...
                <a href="<?=PATH?>" class="back-button">Back to Home</a>
            </div>
